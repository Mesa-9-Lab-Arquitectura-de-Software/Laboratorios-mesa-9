...
const url$1 = process.env.LOGIN_URL;
const port$1 = process.env.LOGIN_PORT;
const entryPoint$1 = process.env.LOGIN_ENTRY;
...
const resolvers$1 = {
	...
	Mutation: {
		login: async (_, { credentials }) =>{
			let res = await	generalRequest(`${URL$1}`, 'POST', credentials);
			console.log(res);
			if(res){
